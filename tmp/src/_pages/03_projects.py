...
from old.src.data.project_store import (
    get_all_projects,
    create_project,
    delete_project,
    create_well,
        ...
        if mode == "create":
            ...
            if uploaded is not None:
                try:
                    ...
                    from old.src.data.models import project_from_dict
        ...
        with col_confirm:
            if st.button(confirm_label, type="primary", use_container_width=True):
                if mode == "create":
                    ...
                    import json as _json
                    from old.src.data.project_store import import_project_from_json
