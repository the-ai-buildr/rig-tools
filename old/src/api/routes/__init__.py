...
from old.src.api.routes.health import router as health_router
from old.src.api.routes.calcs import router as calcs_router
from old.src.api.routes.auth import router as auth_router
from old.src.api.routes.projects import router as projects_router
